  ...
  return (
    <div className="navbar  ">
      ...
      <div
        style={{ zIndex: 999 }}
        onClick={handleMenu}
        className="TOP-NAV cursor-pointer fixed text-white right-5 sm:right-16 top-5"
      >
      ...
      <div
        id="menuBar"
        className="menuBar translate-x-full fixed  right-0 top-0 h-[100vh] w-[100vw] flex justify-end backdrop-blur-sm items-center  "
        style={{ backgroundColor: "rgba(12, 10, 9, 0.7)", zIndex: 1000 }} // Set black background with opacity 0.5
      >
        <div className=" MARKEE relative flex-col flex  items-center  w-[3vh] sm:w-[10vh] h-[100vh]   overflow-hidden  bg-gradient-to-br from-pink-600 via-purple-900 to-blue-700"></div>
        <div
          id="menuItems"
        ...
        >
          <div className="Y-AXIS absolute w-full  top-0 py-8 px-4 border-stone-800 border-b-[1px]">
            <div className="TOP-items opacity-0 flex w-full items-center justify-between  text-white">
              {" "}
              <h1 className="font-heading text-[5vw] sm:ml-5 sm:text-[2.5vw] text-stone-300">
                Alonix
              </h1>
              <button
                onClick={handleClose}
                id="close"
                className="Button sm:mr-5 w-[35px] sm:w-[50px]  h-[35px] sm:h-[50px]  rounded-full bg-gradient-to-br from-pink-600 via-purple-900 to-blue-700 text-white flex justify-center items-center text-[15px] sm:text-lg cursor-pointer"
              >
                X
              </button>
            </div>
          ...
          <div className="Y-AXIS w-full  border-stone-800 border-t-[1px]   py-12 absolute  bottom-[0vh] sm:bottom-0">
            <div className="BOTTOM-items flex items-center justify-around w-full">
              <h1 className=" font-text text-[2.5vw] sm:text-[1vw] text-stone-500  tracking-tighter ">
                @Alonix 2025
              </h1>
              <h1
                style={{ wordSpacing: "-0.2rem" }}
                className="font-text text-[2.5vw] sm:text-[1vw] text-stone-500  tracking-tighter "
              >
                Site by @Akib
              </h1>
            </div>
